...
\u2022 Use /play [song name] **Example /play lisa money** or use /play as a reply to an audio file or youtube link.
    ...
    if query.data.lower() == "replay":
        ...
        buttons = [
            ...
            [
                ...
                InlineKeyboardButton("FRIENDS CHAT GROUP", url="https://t.me/+EM5AEBz2D-81MzQ1"),
            ],
            [
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/+uq8Lft49fz40YmU1"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/+uq8Lft49fz40YmU1"),
            ],
            [
                InlineKeyboardButton("MORE BOTS", url="https://t.me/+uq8Lft49fz40YmU1"),
                InlineKeyboardButton("SOURCE CODE", url="https://t.me/+uq8Lft49fz40YmU1"),
            ],
            [
...
async def start(client, message):
    ...
    reply_markup = InlineKeyboardMarkup(buttons)
    m=await message.reply_photo(photo="te.legra.ph/file/358572191a59046ed6bf7.jpg", caption=HOME_TEXT.format(message.from_user.first_name, message.from_user.id), reply_markup=reply_markup)
    await mp.delete(m)
...
async def help(client, message):
    ...
    msg['help'] = await message.reply_photo(photo="te.legra.ph/file/358572191a59046ed6bf7.jpg", caption=HELP_TEXT, reply_markup=reply_markup)
    await mp.delete(message)
